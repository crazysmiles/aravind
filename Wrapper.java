...
public void getByLinkText(String linktext,String Text){
	
    	 try {
			  if(driver.findElement(By.xpath(linktext)).getText().contains(Text))
			  {
...
public String readCellFromExcel(String TCWorkBook, int row, int col) throws IOException {
 ...
 return currentrow.getCell(col-1).getStringCellValue();
}
